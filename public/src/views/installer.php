...
<head>
	...
	<title>Installation Checkup</title>
...
<body>
	...
	<h1><a href="#" target="_blank"><img width="45" height="38" border="0" alt="MyProject" class="logo" src="img/logo.png"></a>Environment Tests
	<span>
	...
	<p>
		The following tests have been run to determine if <a href="#">MyProject</a> will work in your environment.<br />
		If any of the tests have failed, consult the <a href="#/docs"> online documentation</a>
	...
	<table cellspacing="0">
		<tr>
			<th>PHP Version</th>
			<?php if (phpCheck(7.1)): $php_version = true; ?>
				<td class="pass"><?php echo PHP_VERSION ?></td>
			<?php else: $failed = TRUE ?>
				<td class="fail">MyProject requires PHP 7.1 or newer, your current PHP version is <?php echo PHP_VERSION ?>.</td>
			<?php endif ?>
		</tr>
		<tr>
		<!--tr>
		...
		<tr>
			...
			<?php if ( (function_exists('mysql_connect') ||
				...
				<td class="pass">Pass</td>
			<?php else: $failed = TRUE ?>
				<td class="fail">None of the required database client libraries are installed. You will not be able to use MyProject unless you install one or more of these client libraries.</td>
			<?php endif ?>
		</tr>
	...
	<?php if ($failed === TRUE): ?>
		<p id="results" class="fail">✘ MyProject may not work correctly with your environment.</p>
	<?php else: ?>
		<p id="results" class="pass">✔ Your environment passed <?php echo $all_pass ? 'all' : 'basic'; ?> requirements to run MyProject.
		</p>
	<?php endif ?>
	...
	<p>
		At least one of the following is required to use MyProject.
	</p>
	...
	<p>
		The following extensions are not required to run MyProject, but if enabled, they can provide additional functionality.
	</p>
	...
	<table cellspacing="0" style="margin-bottom:50px">
		<tr>
			...
			<?php if (extension_loaded('curl')): ?>
				<td class="pass">Pass</td>
			<?php else: ?>
				<td class="fail">MyProject uses the <a href="http://php.net/curl">cURL</a> extension is needed for some purpose.</td>
			<?php endif ?>
		</tr>
